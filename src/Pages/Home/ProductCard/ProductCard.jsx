...
//     const reseller = users?.filter(user => user.role === 'reseller' && currentUser === user?.email);
...
//                             {/* {
//                                 customer && <span className="text-xl font-bold text-violet-600">${item?.customerPrice}</span>
//                             } */}
//                             {
//                                 reseller && <span className="text-xl font-bold text-violet-600">${item?.
//                                     resellerPrice}</span>
//                             }
